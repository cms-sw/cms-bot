...
KNOWN_ERRORS["relvals"]["CMSSW_(10_[2-9]|[1-9][1-9])_.+"]["slc7_amd64_700"]= deepcopy(KNOWN_ERRORS["relvals"]["CMSSW_10_[0-1]_.+"]["slc7_amd64_gcc700"])
for wf in ["523.0", "551.0","554.0","555.0","562.0","1360.0","25210.0"]:
  KNOWN_ERRORS["relvals"]["CMSSW_(10_[2-9]|[1-9][1-9])_.+"]["slc7_amd64_700"][wf]=deepcopy(KNOWN_ERRORS["relvals"]["CMSSW_10_[0-1]_.+"][".+_amd64_gcc700"][wf])
