...
ssh $SSH_OPTS ${TARGET} "setenv _CONDOR_SCHEDD_HOST bigbird15.cern.ch && setenv _CONDOR_CREDD_HOST bigbird15.cern.ch && condor_ssh_to_job -auto-retry $2 'java -jar ${WORKSPACE}/slave.jar -jar-cache ${WORKSPACE}/tmp'"
