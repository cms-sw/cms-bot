...
if __name__ == "__main__":
    parser = OptionParser(
        usage="%prog <jenkins-build-number> <pr-id> <arch> <last_commit> <message-type> <package-name> [ options ] \n "
