...
TRIGGER_PR_TESTS = [ "nclopezo" , "ktf", "smuzaffar", "degano", "davidlange6", "mark-grimes" ]
...
CMSSW_CATEGORIES={
  ...
  "core": [
   ...
   "DataFormats/CLHEP",
   "DataFormats/Common",
   "Validation/Performance", "Utilities/DCacheAdaptor",
   "Utilities/General",
 ...
 "reconstruction": [
   ...
   "CommonTools/Utils",
   "CondCore/HIPlugins", "EventFilter/CSCRawToDigi",
   ...
   "Utilities/RelMon",
   "Validation/Configuration", "RecoBTag/BTagTools",
   "RecoBTag/Configuration",
   "RecoBTag/ImpactParameter",
   "RecoBTag/ImpactParameterLearning",
   "RecoBTag/PerformanceDB",
   "RecoBTag/Records",
   "RecoBTag/SecondaryVertex", "RecoBTag/Skimming",
   "RecoBTag/SoftLepton",
   "RecoBTag/TrackProbability", "RecoBTag/XMLCalibration",
