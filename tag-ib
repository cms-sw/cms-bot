...
if __name__ == "__main__":
  ...
  parser.add_option("-n", "--dry-run", dest="dryRun", help="Do not modify Github",  default=False, action="store_true") 
  parser.add_option("-b", "--branch",  dest="branch", help="Repository branch to use for tagging e.g CMSSW_8_0_X", type=str, default=None)
  parser.add_option("-d", "--date",    dest="date",   help="Date/time to search for the commit to tag e.g. 2015-10-19-1100", type=str, default=None)
  parser.add_option("-t", "--tag",     dest="tag",    help="Tag of the IB e.g. CMSSW_8_0_X_2015-10-19-1100. Default is <Branch>_<YYYY-MM-DD-HH00>", type=str, default=None)
