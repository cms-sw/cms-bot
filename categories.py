...
CMSSW_CATEGORIES={"operations": ["Configuration/Applications",
  ...
  "PerfTools/Callgrind", "PerfTools/EdmEvent", "IOMC/Input",
  ...
  "CondCore/CalibPlugins", "CondCore/CastorPlugins", "CondCore/CondDB", "CondCore/DBCommon",
  ...
  "Geometry/HcalSimData", "Geometry/HGCalCommonData", "Geometry/HcalTestBeamData", "Geometry/HcalTowerAlgo",
  ...
  "RecoEgamma/EgammaHLTProducers"], "analysis": ["EgammaAnalysis/ElectronTools",
  "CondFormats/JetMETObjects", "HiggsAnalysis/CombinedLimit",
 ...
 "GeneratorInterface/PomwigInterface",
  ...
  "GeneratorInterface/ThePEGInterface", "DataFormats/HepMCCandidate", "SimDataFormats/GeneratorProducts",
  "Validation/EventGenerator", "IOMC/ParticleGuns"], "daq": ["Configuration/SiStripDAQ",
  ...
  "DQM/TrackingMonitorClient", "DQM/TrackingMonitorSource",
  ...
  "DQM/HcalMonitorModule", "DQM/HcalMonitorTasks", 
  "DQM/Integration",
  "DQM/L1TMonitor",
  ...
  "DQMServices/Examples", "DQMServices/FwkIO", 
  "DQMServices/StreamerIO", "DQMServices/XdaqCollector",
