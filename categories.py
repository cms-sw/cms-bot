...
TRIGGER_PR_TESTS = list(set([ "lgray", "wmtan", "bsunanda", "VinInn", "kpedro88", "makortel", "iahmad-khan" ] + REQUEST_BUILD_RELEASE + [ a for a in authors if authors[a]>10 and not a in GITHUB_BLACKLIST_AUTHORS ]))
