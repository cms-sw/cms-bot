...
print(
    "        <p>This page displays a summary of all CMS Jenkins projects , their sub projects , upstream projects <br /> and downstream   	projects. To see the deatil and confgiuration of a project in Jenkins , click on project name. </p><br />"
)
print("      </div>")
print("    </div>")
print("  </div>")
...
for item in data:
    ...
    print(
        ...
        + name
        + '"'
        + '><a href="https://cmssdt.cern.ch/jenkins/job/'
        + name
        + '"'
        + "><b>"
        + name.upper()
    ...
    if len(item[1]["downstream"]) > 0:
        ...
        print("<li>")
        print(
            "<b>DownStream Projects:</b> ",
            "  ".join(["<a href=" + '"#' + x + '"' + ">" + x + "</a>" for x in d]),
            "<br />",
        )
        print("</li>")
    if len(item[1]["subprojects"]) > 0:
        ...
        print(
            "<b>Sub Projects:</b> ",
            " ".join(["<a href=" + '"#' + x + '"' + ">" + x + "</a>" for x in sub]),
            "<br />",
        )
        print("</li>")
        for child in sub:
    ...
    if len(item[1]["upstream"]) > 0:
        ...
        print("<li>")
        print(
            "<b>UpStream Projects:</b> ",
            " ".join(["<a href=" + '"#' + x + '"' + ">" + x + "</a>" for x in up]),
            "<br />",
        )
        print("</li><br />")
    print(" </ul>")
...
print(
    '      <div style="text-align: center; padding-top: 50px;" class="span4"><a style="font-size: 80%;" href="http://copyright.web.cern.ch">Copyright 1954-2015 CERN <br />'
    + "Last Updated: "
