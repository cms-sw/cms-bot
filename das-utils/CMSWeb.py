...
class CMSWeb (object):
  ...
  def search(self, lfn):
    lfn_data = {"ds_status":"UNKNOWN", "ds_block":"UNKNOWN", "ds_owner":"UNKNOWN","at_cern":"UNKNOWN","dataset":"UNKNOWN","ds_files":"0"}
    ...
    if status: lfn_data['ds_status'] = res
  ...
  def search_block(self, block):
    ...
    for replica in jmsg['phedex']['block'][0]['replica']:
      ...
      if replica["node"] == "T2_CH_CERN": block_data["at_cern"] = "yes"
