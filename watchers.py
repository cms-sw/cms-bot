...
WATCHERS = {
  ...
  "mmarionncern" : [ "CondFormats/JetMETObjects" , "DQMOffline/JetMET" , "DataFormats/METReco" ,
               ...
               "Validation/RecoMET" ],
  "abbiendi": [ "Alignment/MuonAlignment",
		"Alignment/MuonAlignmentAlgorithms",
		...
		"Validation/RecoMuon"],
  "trocino": [ "Alignment/MuonAlignment",
		"Alignment/MuonAlignmentAlgorithms",
		"DataFormats/CSCRecHit",
		"DataFormats/GEMRecHit",
		"DataFormats/DTRecHit",
		...
		"Validation/MuonIsolation",
		"Validation/RecoMuon"],
  "battibass": [ "Alignment/MuonAlignment",
		"Alignment/MuonAlignmentAlgorithms",
		"DataFormats/CSCRecHit",
		"DataFormats/GEMRecHit",
		"DataFormats/DTRecHit",
  ...
  "yduhm": ["RecoLocalTracker/ClusterParameterEstimator",
                "RecoLocalTracker/Configuration",
                "RecoLocalTracker/Records",
                "RecoLocalTracker/SiStrip*",
                "RecoLocalTracker/SubCollectionProducers"],
  "gbenelli": ["RecoLocalTracker/ClusterParameterEstimator",
                "RecoLocalTracker/Configuration",
                "RecoLocalTracker/Records",
                "RecoLocalTracker/SiStrip*",
                "RecoLocalTracker/SubCollectionProducers",
  ...
  "forthommel": ["RecoLocalTracker/ClusterParameterEstimator",
                "RecoLocalTracker/Configuration",
                "RecoLocalTracker/Records",
                "RecoLocalTracker/SiStrip*",
                "RecoLocalTracker/SubCollectionProducers"],
  "lbeck":      ["SimTracker/SiStripDigitizer",
                "SimTracker/Common",
                "SimTracker/Configuration",
                "SimTracker/Records"],
  "prolay":      ["SimTracker/SiStripDigitizer",
                "SimTracker/Common",
                "SimTracker/Configuration",
                "SimTracker/Records"],
}
