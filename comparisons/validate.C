...
void validateEvents(TString step, TString file, TString refFile, TString r="RECO", bool SHOW=false, TString sr="")
{
  ...
  if (!step.Contains("hlt")){
    ...
    if (step.Contains("all") || step.Contains("ctpps")){
      ...
      plotvar(tbr+recoS+".obj@.size()");
      plotvar(tbr+recoS+".obj.fedId()");
      plotvar(tbr+recoS+".obj.optoRxId()");
      plotvar(tbr+recoS+".obj.fSize()");
      ...
      plotvar(tbr+recoS+".obj._sets.data.chipPosition()");
      plotvar(tbr+recoS+".obj._sets.data.numberOfClusters()");
      tbr="TotemRPDigiedmDetSetVector_totemRPRawToDigi_RP_";
      plotvar(tbr+recoS+".obj._sets@.size()");
      plotvar(tbr+recoS+".obj._sets.data@.size()");
      plotvar(tbr+recoS+".obj._sets.data.stripNumber()");
      ...
      plotvar(tbr+recoS+".obj._sets@.size()");
      plotvar(tbr+recoS+".obj._sets.data@.size()");
      plotvar(tbr+recoS+".obj._sets.data.position()");
      plotvar(tbr+recoS+".obj._sets.data.sigma()");
      tbr="TotemRPClusteredmDetSetVector_totemRPClusterProducer__";
      plotvar(tbr+recoS+".obj._sets@.size()");
      plotvar(tbr+recoS+".obj._sets.data@.size()");
      plotvar(tbr+recoS+".obj._sets.data.stripBegin()");
      plotvar(tbr+recoS+".obj._sets.data.numberOfStrips()");
      tbr="TotemRPUVPatternedmDetSetVector_totemRPUVPatternFinder__";
      plotvar(tbr+recoS+".obj._sets@.size()");
      plotvar(tbr+recoS+".obj._sets.data@.size()");
      plotvar(tbr+recoS+".obj._sets.data.projection()");
      plotvar(tbr+recoS+".obj._sets.data.a()");
      plotvar(tbr+recoS+".obj._sets.data.b()");
      plotvar(tbr+recoS+".obj._sets.data.w()");
      plotvar(tbr+recoS+".obj._sets.data.fittable()");
      tbr="TotemRPLocalTrackedmDetSetVector_totemRPLocalTrackFitter__";
      plotvar(tbr+recoS+".obj._sets@.size()");
      plotvar(tbr+recoS+".obj._sets.data@.size()");
      plotvar(tbr+recoS+".obj._sets.data.hits()@.size()");
      plotvar(tbr+recoS+".obj._sets.data.x0()");
      plotvar(tbr+recoS+".obj._sets.data.y0()");
      plotvar(tbr+recoS+".obj._sets.data.z0()");
      plotvar(tbr+recoS+".obj._sets.data.tx()");
      plotvar(tbr+recoS+".obj._sets.data.ty()");
      plotvar(tbr+recoS+".obj._sets.data.chiSquared()");

      tbr="CTPPSLocalTrackLites_ctppsLocalTrackLiteProducer__";
      plotvar(tbr+recoS+".obj@.size()");
      plotvar(tbr+recoS+".obj.x()");
      plotvar(tbr+recoS+".obj.xUnc()");
      plotvar(tbr+recoS+".obj.y()");
      plotvar(tbr+recoS+".obj.yUnc()");
      plotvar(tbr+recoS+".obj.time()");
      plotvar(tbr+recoS+".obj.timeUnc()");
    }
