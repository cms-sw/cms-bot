...
def configureProfilingSteps(cmsdriver_lines, num_events):
    ...
    new_cmdlist = (cmsdriver_lines[:2] +
        ...
        "mv IgProf.{nev}.gz step3_igprofCPU.{nev}.gz".format(nev=num_events/2),
        "mv IgProf.{nev}.gz step3_igprofCPU.{nev}.gz".format(nev=num_events-1),
        echoBefore(igprof_s3_mp, "step3 IgProf mp"),
        "mv IgProf.1.gz step3_igprofMEM.1.gz",
        "mv IgProf.{nev}.gz step3_igprofMEM.{nev}.gz".format(nev=num_events/2),
        "mv IgProf.{nev}.gz step3_igprofMEM.{nev}.gz".format(nev=num_events-1),
        ] +
        ...
        "mv IgProf.{nev}.gz step4_igprofCPU.{nev}.gz".format(nev=num_events/2),
        "mv IgProf.{nev}.gz step4_igprofCPU.{nev}.gz".format(nev=num_events-1),
        echoBefore(igprof_s4_mp, "step4 IgProf mp"),
        "mv IgProf.1.gz step4_igprofMEM.1.gz",
        "mv IgProf.{nev}.gz step4_igprofMEM.{nev}.gz".format(nev=num_events/2),
        "mv IgProf.{nev}.gz step4_igprofMEM.{nev}.gz".format(nev=num_events-1),
        ])
