...
summaryLines += [
    ...
    "            if (label.includes(searchText) || type.includes(searchText) || record.includes(searchText)) {",
   ...
   '<table><tr><td bgcolor="orange">',
    ...
    % selector_options,
    '<th align="center">Search<BR><input type="text" id="moduleSearch" placeholder="label/type/record" onkeyup="filterTable()" style="width:150px"></th>',
    "</tr>",
]
