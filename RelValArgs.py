...
RELVAL_KEYS["PREFIX"]["CMSSW_([89]|[1-9][0-9]+)_.+"] = "--prefix '%s/monitor_workflow.py timeout --signal SIGTERM 7200 '" % scriptPath
RELVAL_KEYS["PREFIX"]["CMSSW_[1-7]_.+"]              = "--prefix '%s/monitor_workflow.py timeout --signal SIGSEGV 7200 '" % scriptPath
