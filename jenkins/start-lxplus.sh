...
ssh -f $SSH_OPTS -n $TARGET "mkdir -p $WORKSPACE $WORKER_DIR/foo $WORKER_DIR/cache; rm -rf $WORKSPACE/workspaceX; ls -d $WORKER_DIR/* | grep -v $WORKER_DIR/cache | xargs rm -rf ; rm -rf /tmp/??"
